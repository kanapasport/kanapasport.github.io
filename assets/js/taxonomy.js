...
window.KB_ICONS = {
    ...
    car:      '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 17H4a1 1 0 01-1-1v-3.5a2 2 0 01.4-1.2L5.6 8.2A2 2 0 017.2 7.4h9.6a2 2 0 011.6.8l2.2 3.1a2 2 0 01.4 1.2V16a1 1 0 01-1 1h-1M5 17a2 2 0 104 0m-4 0a2 2 0 114 0m6 0a2 2 0 104 0m-4 0a2 2 0 114 0m-6 0H9M3.5 12h17"/>',
...
window.KB_CATEGORIES = [
    {
        ...
        title: 'FIREMNÍ',
        icon: 'building',
        /* Interní firemní dokumenty – směrnice, šablony, provozní věci.
           Podsekce zatím žádné; návody se zakládají rovnou do sekce. */
        children: []
    },
    {
        id: 'skripty',
...
/* Barva sekce návodů – oddělují se jí dlaždice i podlišta. Šedá je pro
   návody bez kategorie. */
window.KB_katBarva = (katId) => {
    const c = (window.KB_CATEGORIES || []).find(x => x.id === katId);
